...
// Do Not Edit
// Generated by Blip
// source blip: ..//users/listUsers.blip.html
...
func ListUsersRender( name string, c context.Context, w io.Writer ) (terror error) {
    start := time.Now()
	...
	terror = template.HeadRender("User Page", c, w)
	...
	terror = template.TestRender(ctxL1, w)
	if terror != nil { return }
	// Line: 15
	si.Write(w, []byte("\nThe end of the line\n"))
	// Line: 20
