...
func ListActiveUsersProcess( users []*model.User, c context.Context, w io.Writer ) (terror error) {
    start := time.Now()
	...
	terror = RootProcess("Active Users", ctxL1, w)
